...
const errors = [];
// Requests to third-party hosts (the Google Fonts stylesheet, Firebase) are
// aborted: a sandboxed CI network is not an app fault. Record them separately
// so a real application error is never hidden among them.
const external = [];
