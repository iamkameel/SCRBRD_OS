...
INSERT INTO role_capability (role, capability) VALUES
  ...
  ('superadmin', 'school.manage'),
  ('superadmin', 'user.read'),
  ('superadmin', 'user.invite'),
  ('superadmin', 'user.role.assign'),
  ('superadmin', 'audit.read'),
  ('superadmin', 'team.read'),
  ('superadmin', 'team.manage'),
  ('superadmin', 'team.select'),
  ('superadmin', 'availability.read'),
  ('superadmin', 'availability.declare'),
  ('superadmin', 'player.profile.read'),
  ('superadmin', 'player.profile.manage'),
  ('superadmin', 'player.pii.read'),
  ('superadmin', 'player.emergency.read'),
  ('superadmin', 'player.emergency.manage'),
  ('superadmin', 'player.workload.read'),
  ('superadmin', 'player.workload.manage'),
  ('superadmin', 'recognition.manage'),
  ('superadmin', 'clearance.read'),
  ('superadmin', 'clearance.manage'),
  ('superadmin', 'player.performance.read'),
  ('superadmin', 'player.performance.write'),
  ('superadmin', 'player.development.read'),
  ('superadmin', 'player.development.write'),
  ('superadmin', 'player.note.read'),
  ('superadmin', 'player.note.write'),
  ('superadmin', 'fixture.read'),
  ('superadmin', 'fixture.create'),
  ('superadmin', 'fixture.update'),
  ('superadmin', 'fixture.cancel'),
  ('superadmin', 'scoring.start'),
  ('superadmin', 'scoring.edit'),
  ('superadmin', 'scoring.finalise'),
  ('superadmin', 'scoring.correct'),
  ('superadmin', 'scoring.amend.approve'),
  ('superadmin', 'officiating.assign'),
  ('superadmin', 'officiating.report'),
  ('superadmin', 'officiating.registry.manage'),
  ('superadmin', 'medical.status.read'),
  ('superadmin', 'medical.nature.read'),
  ('superadmin', 'medical.details.read'),
  ('superadmin', 'medical.write'),
  ('superadmin', 'player.roster.read'),
  ('superadmin', 'player.age.read'),
  ('superadmin', 'player.biometric.read'),
  ('superadmin', 'player.identity.read'),
  ('superadmin', 'guardian.link.manage'),
  ('superadmin', 'player.access.request'),
  ('superadmin', 'player.access.grant'),
  ('superadmin', 'discipline.read'),
  ('superadmin', 'discipline.write'),
  ('superadmin', 'transport.read'),
  ('superadmin', 'transport.manage'),
  ('superadmin', 'transport.drive'),
  ('superadmin', 'facility.read'),
  ('superadmin', 'facility.manage'),
  ('superadmin', 'invoice.read'),
  ('superadmin', 'invoice.manage'),
  ('superadmin', 'sponsorship.read'),
  ('superadmin', 'sponsorship.manage'),
  ('superadmin', 'sponsorship.exclusivity.waive'),
  ('superadmin', 'sponsorship.finance.read'),
  ('superadmin', 'competition.read'),
  ('superadmin', 'competition.manage'),
  ('superadmin', 'news.read'),
  ('superadmin', 'news.publish.team'),
  ('superadmin', 'news.publish.school'),
  ('superadmin', 'news.publish.competition'),
  ('superadmin', 'broadcast.publish'),
  ('superadmin', 'analytics.read'),
  ('superadmin', 'opposition.read'),
  ('superadmin', 'scouting.read'),
  ('superadmin', 'scouting.write'),
  ('superadmin', 'platform.health.read'),
  ('superadmin', 'platform.tenant.manage'),
  ('superadmin', 'scouting.accredit'),
  ('superadmin', 'platform.support.impersonate'),
  ('superadmin', 'platform.feature.manage'),
  ('superadmin', 'platform.reward.manage'),
  ('superadmin', 'school.feature.manage'),
  ...
  ('directorofsport', 'player.emergency.read'),
  ('directorofsport', 'player.emergency.manage'),
  ...
  ('schooladmin', 'player.emergency.read'),
  ('schooladmin', 'player.emergency.manage'),
  ...
  ('assistantcoach', 'player.emergency.read'),
  ...
  ('teammanager', 'player.emergency.read'),
  ...
  ('guardian', 'player.emergency.read'),
  ('guardian', 'player.emergency.manage'),
  ...
  ('transportcoordinator', 'player.emergency.read'),
  ('driver', 'news.read'),
...
INSERT INTO role_grantable (granter, role) VALUES
  ...
  ('superadmin', 'directorofsport'),
  ('superadmin', 'schooladmin'),
  ('superadmin', 'sportsadmin'),
  ('superadmin', 'coach'),
  ('superadmin', 'assistantcoach'),
  ('superadmin', 'teammanager'),
  ('superadmin', 'scorer'),
  ('superadmin', 'official'),
  ('superadmin', 'player'),
  ('superadmin', 'enquiry'),
  ('superadmin', 'selfaccess'),
  ('superadmin', 'guardian'),
  ('superadmin', 'analyst'),
