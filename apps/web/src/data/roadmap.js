...
export const UPGRADES = [
  ...
  { id: "up3",  category: "Integrations",  priority: "high",   status: "shipped", title: "Live Score Sync",
    desc: "Match Centre reads the live fold from the ball log. Offline queue, device handover, voided balls and a way out of quarantine all covered. A delivery that completes an innings opens a review of the derived figures rather than sealing it, and confirming writes the innings_end event that records why it ended.", effort: "Medium", walk: ["sync", "browser-sync", "handover", "browser-handover", "quarantine"] },
